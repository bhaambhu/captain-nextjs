...
//     // If we got a 401 while trying to refresh token, we need to login again
//     if (
//       error.response.status === 401 &&
//       originalRequest.url === baseURL + APIEndpoints.TOKEN_REFRESH
//     ) {
//       alert(
...
//     // If we got 401 simply, we need to refresh token
//     if (
